...
const bobSend = mssge => {
  ...
  let BobMssge = document.createElement("div");
  BobCht.classList.add("Sender", "chat", "chat-sent");
  BobMssge.classList.add("Sender", "message-sent");
  BobMssge.innerText = mssge;
  BobCht.appendChild(BobMssge);
...
const AshlyReceive = mssge => {
  ...
  AshCht.classList.add("Receiver","chat", "chat-received")
  AshMssg.classList.add("Receiver", "message-received");
